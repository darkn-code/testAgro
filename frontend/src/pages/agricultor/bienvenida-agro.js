  ...
  const [nombre, setNombre] = useState('');
    ...
    useEffect(() => {
      ...
      if (nombreguardado) {
        ...
        .then(data=>{
          if(data.ruta_foto){
            setFotoPerfil(`http://192.168.1.70:5000${data.ruta_foto}`);
          }
        })
    ...
    <div className="container">
      ...
      <div className={`sidebar ${menuAbierto ? 'active' : ''}`}>
        <div className="perfil">
          ...
          <Link to="/perfil-agro" className="nombre-usuario">{nombre}</Link>
        </div>
        <div className="menulateral">
          <Link to="/miscultivos-agro">
            <button className="btn btn-success w-100" id="boton">Mis cultivos</button>
          </Link>
      ...
      <div className="bienvenida">
        ...
        <div className="secciones">
          <div className="seccion">
            <Link to="/monitoreo-agro">
            <img src="../imagenes/monitoreo.jpg" className="imagen-seccion" id="monitoreo"/>
            </Link>
            <label className="form-label">Monitoreo</label>
            </div>
            <div className="seccion">
                <Link to="/analisis-agro">
